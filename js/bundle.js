...
$( document ).ready(function() {
  ...
  function generateCharts(categories, countries) {
    ...
    countries.forEach(function(country) {
      ...
      $('.charts').append("<div class='col-2 country-chart'><div class='chart-header'><img src='assets/flags/AFG.png'/><div>" + countryName + "<span>" + datasetCount + " datasets</span></div></div><div class='chart " + chartName + "'></div></div>");
